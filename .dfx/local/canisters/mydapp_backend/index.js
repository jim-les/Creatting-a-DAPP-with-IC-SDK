...
import { idlFactory } from './mydapp_backend.did.js';
export { idlFactory } from './mydapp_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYDAPP_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mydapp_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mydapp_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mydapp_backend.did.js")._SERVICE>}
 */
export const mydapp_backend = createActor(canisterId);
