...
import { idlFactory } from './mydapp_frontend.did.js';
export { idlFactory } from './mydapp_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYDAPP_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mydapp_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mydapp_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mydapp_frontend.did.js")._SERVICE>}
 */
export const mydapp_frontend = createActor(canisterId);
